...
3. **Retrieve:** Automatically locates the associated local repository, creates a clean branch, and pulls the patch.
4. **Review & Audit:** Reviews the uncommitted diff for security flaws, logic errors, or style violations, running static analysis tools if configured, and attempts to fix minor issues locally.
